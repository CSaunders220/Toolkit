...
while($operation){
    ...
    elseif($choice -eq 4){
        ...
        Write-Host "User: $name Removed." | Out-String
            ...
            Write-Host "User does not exist and cannot be removed"
        }
    }
    ...
    elseif($choice -eq 5){
        ...
        Write-Host "User: $name Enabled." | Out-String
            ...
            Write-Host "User does not exist and cannot be enabled"
        }
    }
    ...
    elseif($choice -eq 6){
        ...
        Write-Host "User: $name Disabled." | Out-String
            ...
            Wite-Host "User doe snot exist and cannot be disabled"
        }
    }
    ...
    elseif($choice -eq 7){
        ...
        Write-Host ($userLogins | Where-Object { $_.User -ilike "*$name"} | Format-Table | Out-String)
            ...
            Write-Host "User does not exist and logs cannot be displayed."
        }
    }
    ...
    elseif($choice -eq 8){
        ...
        Write-Host ($userLogins | Where-Object { $_.User -ilike "*$name"} | Format-Table | Out-String)
            ...
            Write-Host "User cannot be found and logs could not be printed"
        }
    }
